...
//
// Three files legitimately need the raw values, named here rather than left
...
//   - src/design/tokens.css is generated by tokens-to-css.mjs from
//     design/tokens.json and overwritten on every prepare/build/typecheck,
//     so a hand-written raw reference can never survive here. Its alias
//     layer (--text-1, --brand, --surface-*, ...) is exactly where the raw
//     ramps get DEFINED into the semantic names every other file reads --
//     the machine-written successor to the definitional role ox.css used
//     to hold alone (see ADR-019 D4, the one-pipeline-not-two fold).
...
const ALLOWED_PATHS = new Set([
  ...
  "design/ox.css",
  // Generated by scripts/tokens-to-css.mjs from design/tokens.json;
  // overwritten on every prepare/build/typecheck, so a hand-written raw
  // reference can never survive here. Its alias layer is where the raw
  // ramps are DEFINED into the semantic names.
  "design/tokens.css",
