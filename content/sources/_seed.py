...
# id, work, author, year, gutenberg id, text, words
SOURCES: list[tuple[str, str, str, int, int, str, list[str]]] = [
    (
    ...
    (
        ...
        "Moby-Dick; or, The Whale", "Herman Melville", 1851, 2701,
        "meditation and water are wedded for ever. But here is an artist. "
        "He desires to paint you the dreamiest, shadiest, quietest, most "
        "enchanting bit of romantic landscape in all the valley of the "
        "Saco. What is the chief element he employs? There stand his "
        "trees, each with a hollow trunk, as if a hermit and a crucifix "
        "were within; and here sleeps his meadow, and there sleep his "
        "cattle; and up from yonder cottage goes a sleepy smoke. Deep into "
        "distant woodlands winds a mazy way, reaching to overlapping spurs "
        ...
        "vain, unless the shepherd's eye were fixed upon the magic stream "
        "before him. Go visit the Prairies in June, when for scores on "
        "scores of miles you wade knee-deep among Tiger-lilies—what is "
        "the one charm wanting?—Water—there is not a drop of "
        "water there! Were Niagara but a cataract of sand, would you "
        "travel your thousand miles to see it?",
        ["mazy", "tranced", "cataract"],
    ),
    (
        ...
        "Mr. Bennet replied that he had not. “But it is,” "
    ...
    (
        ...
        "life that he became a husband and the father of a family. As the "
        "circumstances of his marriage illustrate his character, I cannot "
        "refrain from relating them. One of his most intimate friends was "
        "a merchant who, from a flourishing state, fell, through numerous "
        "mischances, into poverty. This man, whose name was Beaufort, was "
        "of a proud and unbending disposition and could not bear to live "
        "in poverty and oblivion in the same country where he had "
        "formerly been distinguished for his rank and magnificence.",
        ["syndics", "indefatigable", "unbending"],
    ),
    (
        ...
        "with such infinite pains and care I had endeavoured to form? His "
        "limbs were in proportion, and I had selected his features as "
        "beautiful. Beautiful! Great God!",
        ["toils", "convulsive", "delineate"],
    ),
    (
        "src-stoker-castle-on-the-edge",
        "Dracula", "Bram Stoker", 1897, 345,
        "The castle is on the very edge of a terrible precipice. A stone "
        "falling from the window would fall a thousand feet without "
        "touching anything! As far as the eye can reach is a sea of green "
        "tree tops, with occasionally a deep rift where there is a chasm. "
        "Here and there are silver threads where the rivers wind in deep "
        "gorges through the forests. But I am not in heart to describe "
        "beauty, for when I had seen the view I explored further; doors, "
        "doors, doors everywhere, and all locked and bolted. In no place "
        "save from the windows in the castle walls is there an available "
        "exit. The castle is a veritable prison, and I am a prisoner!",
        ["precipice", "chasm", "veritable"],
    ),
    (
        "src-stoker-the-dead-travel-fast",
        "Dracula", "Bram Stoker", 1897, 345,
        "“Denn die Todten reiten schnell”—(“For the dead "
        "travel fast.”) The strange driver evidently heard the words, "
        "for he looked up with a gleaming smile. The passenger turned his "
        "face away, at the same time putting out his two fingers and "
        "crossing himself. “Give me the Herr's luggage,” said the "
        "driver; and with exceeding alacrity my bags were handed out and "
        "put in the calèche. Then I descended from the side of the "
        "coach, as the calèche was close alongside, the driver "
        "helping me with a hand which caught my arm in a grip of steel; "
        "his strength must have been prodigious. Without a word he shook "
        "his reins, the horses turned, and we swept into the darkness of "
        "the Pass.",
        ["alacrity", "prodigious"],
    ),
    (
    ...
    (
        ...
        "all going direct the other way—in short, the period was so "
    ...
    (
        ...
        "was now out of the question. I was glad of it: I never liked long "
    ...
    (
        ...
        "said—“Mary, I have been married to Mr. Rochester this "
        "morning.” The housekeeper and her husband were both of that "
        ...
        "the danger of having one's ears pierced by some shrill "
        "ejaculation, and subsequently stunned by a torrent of wordy "
        "wonderment.",
        ["phlegmatic", "ejaculation"],
    ),
    (
    ...
    (
        ...
        "authority of his tombstone and my sister,—Mrs. Joe Gargery, "
        "who married the blacksmith. As I never saw my father or my "
        "mother, and never saw any likeness of either of them (for their "
        "days were long before the days of photographs), my first fancies "
        "regarding what they were like were unreasonably derived from "
        "their tombstones. The shape of the letters on my father's, gave "
        "me an odd idea that he was a square, stout, dark man, with curly "
        "black hair. From the character and turn of the inscription, "
        "“_Also Georgiana Wife of the Above_,” I drew a childish "
    ...
    (
        ...
        "that the child can be exposed to; but the child is small, and its "
        "world is small, and its rocking-horse stands as many hands high, "
        "according to scale, as a big-boned Irish hunter. Within myself, I "
        "had sustained, from my babyhood, a perpetual conflict with "
        "injustice. I had known, from the time when I could speak, that my "
        "sister, in her capricious and violent coercion, was unjust to me.",
        ["capricious"],
    ),
    (
        ...
        "from the stir of society. A perfect misanthropist's "
        ...
        "and when his fingers sheltered themselves, with a jealous "
        "resolution, still further in his waistcoat, as I announced my "
        "name.",
        ["misanthropist"],
    ),
    (
        ...
        "progress, even in seven months: many a window showed black gaps "
        "deprived of glass; and slates jutted off, here and there, beyond "
        "the right line of the roof, to be gradually worked off in coming "
        "autumn storms. I sought, and soon discovered, the three "
        "headstones on the slope next the moor: the middle one grey, and "
        "half buried in heath; Edgar Linton's only harmonized by the turf "
        "and moss creeping up its foot; Heathcliff's still bare. I "
        "lingered round them, under that benign sky: watched the moths "
    ...
    (
        ...
        "of beautiful things. The highest as the lowest form of criticism "
        "is a mode of autobiography. Those who find ugly meanings in "
        "beautiful things are corrupt without being charming. This is a "
        "fault. Those who find beautiful meanings in beautiful things are "
        "the cultivated. For these there is hope. They are the elect to "
        "whom beautiful things mean only beauty. There is no such thing as "
        "a moral or an immoral book. Books are well written, or badly "
        "written. That is all. The moral life of man forms part of the "
        "subject-matter of the artist, but the morality of art consists in "
        "the perfect use of an imperfect medium. No artist desires to "
        "prove anything. Even things that are true can be proved. No "
        "artist has ethical sympathies. No artist is ever morbid.",
        ["morbid"],
    ),
    (
        ...
        "wind was nearly calm, and being bound down the river, the only "
        ...
        "the sky were welded together without a joint, and in the "
        "luminous space the tanned sails of the barges drifting up with "
        "the tide seemed to stand still in red clusters of canvas sharply "
        "peaked, with gleams of varnished sprits. A haze rested on the low "
        "shores that ran out to sea in vanishing flatness. The air was "
        "dark above Gravesend, and farther back still seemed condensed "
        "into a mournful gloom, brooding motionless over the biggest, and "
        "the greatest, town on earth.",
        ["interminable", "luminous", "brooding"],
    ),
    (
        "src-conrad-we-live-as-we-dream-alone",
        "Heart of Darkness", "Joseph Conrad", 1899, 219,
        "“We live, as we dream—alone....” He paused again as "
        "if reflecting, then added: “Of course in this you fellows "
        "see more than I could then. You see me, whom you know....” "
        ...
        "heavy night-air of the river. “...Yes—I let him run "
        "on,” Marlow began again, “and think what he pleased "
        "about the powers that were behind me. I did! And there was "
        "nothing behind me! There was nothing but that wretched, old, "
        "mangled steamboat I was leaning against.”",
        ["wretched"],
    ),
    (
        ...
        "serene in their assurance of their empire over matter. It is "
        "possible that the infusoria under the microscope do the same. No "
        "one gave a thought to the older worlds of space as sources of "
        "human danger, or thought of them only to dismiss the idea of life "
        "upon them as impossible or improbable. At most terrestrial men "
        "fancied there might be other men upon Mars.",
        ["scrutinised", "infusoria", "terrestrial"],
    ),
    (
        "src-wells-the-time-traveller-was-expounding",
        "The Time Machine", "H. G. Wells", 1895, 35,
        "The Time Traveller was expounding a recondite matter to us. His "
        "grey eyes shone and twinkled, and his usually pale face was "
        "flushed and animated. The fire burnt brightly, and the soft "
        "radiance of the incandescent lights in the lilies of silver "
        "caught the bubbles that flashed and passed in our glasses. Our "
        ...
        "trammels of precision. And he put it to us in this "
        "way—marking the points with a lean forefinger—as we sat "
        "and lazily admired his earnestness over this new paradox (as we "
        "thought it) and his fecundity.",
        ["recondite", "trammels", "fecundity"],
    ),
    (
        ...
        "taste for vintages; and though he enjoyed the theatre, had not "
    ...
    (
        ...
        "Strange Case of Dr Jekyll and Mr Hyde", "Robert Louis Stevenson", 1886, 43,
        "man is not truly one, but truly two. I say two, because the "
    ...
    (
        ...
        "first took up his lodging under our roof. I remember him as if "
        "it were yesterday, as he came plodding to the inn door, his "
    ...
    (
        ...
        "plants, unknown to me; here and there I saw snakes. Then I came "
        "to a long thicket of these oaklike trees—live, or evergreen, "
        "oaks, I heard afterwards they should be called—which grew "
        "low along the sand like brambles, the boughs curiously twisted, "
        "the foliage compact, like thatch. The thicket stretched down from "
        "the top of one of the sandy knolls, spreading and growing taller "
        "as it went, until it reached the margin of the broad, reedy fen, "
        "through which the nearest of the little rivers soaked its way "
    ...
    (
        ...
        "You TOM!” No answer. The old lady pulled her spectacles down "
        "and looked over them about the room; then she put them up and "
        "looked out under them. She seldom or never looked _through_ them "
        ...
        "“Well, I lay if I get hold of you I'll—” She did "
    ...
    (
        ...
        "conversations?” So she was considering in her own mind (as "
        ...
        "was nothing so _very_ remarkable in that; nor did Alice think it "
    ...
    (
        ...
        "studded with iron spikes. The founders of a new colony, whatever "
        "Utopia of human virtue and happiness they might originally "
        "project, have invariably recognised it among their earliest "
        "practical necessities to allot a portion of the virgin soil as a "
        "cemetery, and another portion as the site of a prison. Certain it "
        "is that, some fifteen or twenty years after the settlement of the "
    ...
    (
        ...
        "problem? they say, I know an excellent colored man in my town; "
        "or, I fought at Mechanicsville; or, Do not these Southern "
        ...
        "problem? I answer seldom a word. And yet, being a problem is a "
        "strange experience—peculiar even for one who has never been "
        "anything else, save perhaps in babyhood and in Europe.",
        ["compassionately"],
    ),
    (
        "src-douglass-i-was-born-in-tuckahoe",
        "Narrative of the Life of Frederick Douglass, an American Slave",
        "Frederick Douglass", 1845, 23,
        ...
        "containing it. By far the larger part of the slaves know as "
        "little of their ages as horses know of theirs, and it is the "
    ...
    (
        ...
        "much of fate! Still I will proudly declare that there is "
        "something queer about it. Else, why should it be let so cheaply? "
        "And why have stood so long untenanted? John laughs at me, of "
        "course, but one expects that in marriage. John is practical in "
        "the extreme. He has no patience with faith, an intense horror of "
        "superstition, and he scoffs openly at any talk of things not to "
        "be felt and seen and put down in figures. John is a physician, "
        "and perhaps—(I would not say it to a living soul, of "
        "course, but this is dead paper and a great relief to my "
        "mind)—perhaps that is one reason I do not get well faster.",
        ["felicity", "untenanted"],
    ),
    (
        "src-chopin-a-green-and-yellow-parrot",
        "The Awakening", "Kate Chopin", 1899, 160,
        "A green and yellow parrot, which hung in a cage outside the "
        "door, kept repeating over and over: “_Allez vous-en! Allez "
        "vous-en! Sapristi!_ That's all right!” He could speak a "
        "little Spanish, and also a language which nobody understood, "
        "unless it was the mocking-bird that hung on the other side of "
        "the door, whistling his fluty notes out upon the breeze with "
        "maddening persistence. Mr. Pontellier, unable to read his "
        "newspaper with any degree of comfort, arose with an expression "
        "and an exclamation of disgust. He walked down the gallery and "
        "across the narrow “bridges” which connected the Lebrun "
        "cottages one with the other. The parrot and the mocking-bird were "
        "the property of Madame Lebrun, and they had the right to make "
        "all the noise they wished. Mr. Pontellier had the privilege of "
        "quitting their society when they ceased to be entertaining.",
        ["persistence"],
    ),
    (
        ...
        "story. If you know Starkfield, Massachusetts, you know the "
        "post-office. If you know the post-office you must have seen "
        "Ethan Frome drive up to it, drop the reins on his hollow-backed "
        "bay and drag himself across the brick pavement to the white "
        "colonnade; and you must have asked who he was. It was there "
        "that, several years ago, I saw him for the first time; and the "
        "sight pulled me up sharp. Even then he was the most striking "
        "figure in Starkfield, though he was but the ruin of a man. It was "
        "not so much his great height that marked him, for the "
        "“natives” were easily singled out by their lank "
        "longitude from the stockier foreign breed: it was the careless "
        "powerful look he had, in spite of a lameness checking each step "
    ...
    (
        ...
        "Lily Bart. It was a Monday in early September, and he was "
        "returning to his work from a hurried dip into the country; but "
        "what was Miss Bart doing in town at that season? If she had "
        "appeared to be catching a train, he might have inferred that he "
        "had come on her in the act of transition between one and another "
        "of the country houses which disputed her presence after the "
        "close of the Newport season; but her desultory air perplexed "
        "him. She stood apart from the crowd, letting it drift by her to "
        "the platform or the street, and wearing an air of irresolution "
        "which might, as he surmised, be the mask of a very definite "
        "purpose.",
        ["desultory", "irresolution"],
    ),
    (
        "src-cather-last-summer-i-happened",
        "My Ántonia", "Willa Cather", 1918, 242,
        "Last summer I happened to be crossing the plains of Iowa in a "
        "season of intense heat, and it was my good fortune to have for a "
        "traveling companion James Quayle Burden—Jim Burden, as we "
        "still call him in the West. He and I are old friends—we "
        "grew up together in the same Nebraska town—and we had much "
        "to say to each other. While the train flashed through "
        "never-ending miles of ripe wheat, by country towns and "
        "bright-flowered pastures and oak groves wilting in the sun, we "
        "sat in the observation car, where the woodwork was hot to the "
        "touch and red dust lay deep over everything. The dust and heat, "
        "the burning wind, reminded us of many things. We were talking "
        "about what it is like to spend one's childhood in little towns "
        "like these, buried in wheat and corn, under stimulating extremes "
        "of climate.",
        ["stimulating"],
    ),
    (
        ...
        "toil, and furry coats to protect them from the frost. Buck lived "
        "at a big house in the sun-kissed Santa Clara Valley. Judge "
    ...
    (
        ...
        ["ominous", "infallibility", "futility"],
    ),
    (
        ...
        "that it was the only case he had met in which such a visitation "
        "had fallen on a child. The case, I may mention, was that of an "
        "apparition in just such an old house as had gathered us for the "
        "occasion—an appearance, of a dreadful kind, to a little boy "
        "sleeping in the room with his mother and waking her up in the "
        "terror of it; waking her not to dissipate his dread and soothe "
        "him to sleep again, but to encounter also, herself, before she "
        "had succeeded in doing so, the same sight that had shaken him.",
        ["apparition", "dissipate"],
    ),
    (
        ...
        "gain the more dignity from her plain garments, which by the side "
        "of provincial fashion gave her the impressiveness of a fine "
        "quotation from the Bible,—or from one of our elder "
        "poets,—in a paragraph of to-day's newspaper. She was usually "
        "spoken of as being remarkably clever, but with the addition that "
        "her sister Celia had more common-sense. Nevertheless, Celia wore "
        "scarcely more trimmings; and it was only to close observers that "
        "her dress differed from her sister's, and had a shade of "
        "coquetry in its arrangements.",
        ["provincial", "coquetry"],
    ),
    (
        "src-eliot-a-new-theresa",
        "Middlemarch", "George Eliot", 1871, 145,
        "A new Theresa will hardly have the opportunity of reforming a "
        "conventual life, any more than a new Antigone will spend her "
        "heroic piety in daring all for the sake of a brother's burial: "
        "the medium in which their ardent deeds took shape is forever "
        "gone. But we insignificant people with our daily words and acts "
        "are preparing the lives of many Dorotheas, some of which may "
        "present a far sadder sacrifice than that of the Dorothea whose "
        "story we know. Her finely touched spirit had still its fine "
        "issues, though they were not widely visible. Her full nature, "
        "like that river of which Cyrus broke the strength, spent itself "
        "in channels which had no great name on the earth. But the effect "
        "of her being on those around her was incalculably diffusive: for "
        "the growing good of the world is partly dependent on unhistoric "
        "acts; and that things are not so ill with you and me as they "
        "might have been, is half owing to the number who lived "
        "faithfully a hidden life, and rest in unvisited tombs.",
        ["diffusive", "unhistoric"],
    ),
    (
        ...
        "thread-lace, had their toy spinning-wheels of polished "
        "oak—there might be seen in districts far away among the "
        "lanes, or deep in the bosom of the hills, certain pallid "
        "undersized men, who, by the side of the brawny country-folk, "
        "looked like the remnants of a disinherited race. The shepherd's "
        "dog barked fiercely when one of these alien-looking men appeared "
        "on the upland, dark against the early winter sunset; for what "
        "dog likes a figure bent under a heavy bag?—and these pale "
        "men rarely stirred abroad without that mysterious burden. The "
        "shepherd himself, though he had good reason to believe that the "
        "bag held nothing but flaxen thread, was not quite sure that this "
        "trade of weaving could be carried on entirely without the help "
        "of the Evil One.",
        ["pallid", "brawny"],
    ),
    (
        ...
        "family coach, with two fat horses in blazing harness, driven by "
        "a fat coachman in a three-cornered hat and wig, at the rate of "
        "four miles an hour. A black servant, who reposed on the box "
        "beside the fat coachman, uncurled his bandy legs as soon as the "
        "equipage drew up opposite Miss Pinkerton's shining brass plate, "
        "and as he pulled the bell at least a score of young heads were "
        "seen peering out of the narrow windows of the stately old brick "
        "house.",
        ["equipage"],
    ),
    (
        ...
        "Vanity Fair", "William Makepeace Thackeray", 1848, 599,
        "She is always having stalls at Fancy Fairs for the benefit of "
        "these hapless beings. Emmy, her children, and the Colonel, "
        "coming to London some time back, found themselves suddenly "
        "before her at one of these fairs. She cast down her eyes "
        "demurely and smiled as they started away from her; Emmy "
        "scurrying off on the arm of George (now grown a dashing young "
        "gentleman) and the Colonel seizing up his little Janey, of whom "
        "he is fonder than of anything in the world—fonder even than "
        "of his History of the Punjaub. But he never said a word to "
        "Amelia that was not kind and gentle, or thought of a want of hers "
        "that he did not try to gratify. Ah! Vanitas Vanitatum! which of "
        "us is happy in this world? Which of us has his desire? or, "
        "having it, is satisfied?—come, children, let us shut up the "
    ...
    (
        ...
        "clock began to strike, and I began to cry, simultaneously. In "
        "consideration of the day and hour of my birth, it was declared "
        "by the nurse, and by some sage women in the neighbourhood who "
        "had taken a lively interest in me several months before there "
        "was any possibility of our becoming personally acquainted, "
        "first, that I was destined to be unlucky in life; and secondly, "
    ...
    (
        ...
        "trouble myself to repeat; the item of mortality whose name is "
        "prefixed to the head of this chapter. For a long time after it "
        "was ushered into this world of sorrow and trouble, by the parish "
        "surgeon, it remained a matter of considerable doubt whether the "
        "child would survive to bear any name at all; in which case it is "
        "somewhat more than probable that these memoirs would never have "
        "appeared; or, if they had, that being comprised within a couple "
        "of pages, they would have possessed the inestimable merit of "
        "being the most concise and faithful specimen of biography, "
    ...
    (
        ...
        "into admiration and respect, by contemplating the limited "
        ...
        "contempt as he turned over the almost endless creations of the "
    ...
    (
        ...
        "the Avonlea main road dipped down into a little hollow, fringed "
        "with alders and ladies' eardrops and traversed by a brook that "
        "had its source away back in the woods of the old Cuthbert place; "
        "it was reputed to be an intricate, headlong brook in its earlier "
        "course through those woods, with dark secrets of pool and "
        "cascade; but by the time it reached Lynde's Hollow it was a "
        "quiet, well-conducted little stream, for not even a brook could "
        "run past Mrs. Rachel Lynde's door without due regard for decency "
        "and decorum; it probably was conscious that Mrs. Rachel was "
        "sitting at her window, keeping a sharp eye on everything that "
        "passed, from brooks and children up, and that if she noticed "
    ...
    (
        ...
        "child ever seen. It was true, too. She had a little thin face "
        "and a little thin body, thin light hair and a sour expression. "
        "Her hair was yellow, and her face was yellow because she had "
        "been born in India and had always been ill in one way or "
        "another. Her father had held a position under the English "
        "Government and had always been busy and ill himself, and her "
        "mother had been a great beauty who cared only to go to parties "
        "and amuse herself with gay people. She had not wanted a little "
        "girl at all, and when Mary was born she handed her over to the "
        "care of an Ayah, who was made to understand that if she wished "
        "to please the Mem Sahib she must keep the child out of sight as "
        "much as possible.",
        ["disagreeable"],
    ),
    (
        ...
        "Jo, rummaging her sister's desk for stamps, found a bit of paper "
        ...
        "followed. The invalids improved rapidly, and Mr. March began to "
        "talk of returning early in the new year. Beth was soon able to "
        "lie on the study sofa all day, amusing herself with the "
        "well-beloved cats at first, and in time with doll's sewing, "
        "which had fallen sadly behind-hand. Her once active limbs were "
        "so stiff and feeble that Jo took her for a daily airing about "
        "the house in her strong arms.",
        ["invalids"],
    ),
    (
        ...
        "companions always called me. I had two elder brothers, one of "
    ...
    (
        ...
        "piece of canvas, I began to think of making another raft; but "
        "while I was preparing this, I found the sky overcast, and the "
        "wind began to rise, and in a quarter of an hour it blew a fresh "
        "gale from the shore. It presently occurred to me that it was in "
    ...
    (
        ...
        "Gulliver's Travels", "Jonathan Swift", 1726, 829,
        "I was in the utmost astonishment, and roared so loud, that they "
        "all ran back in a fright; and some of them, as I was afterwards "
        "told, were hurt with the falls they got by leaping from my sides "
        "upon the ground. However, they soon returned, and one of them, "
        "who ventured so far as to get a full sight of my face, lifting "
        "up his hands and eyes by way of admiration, cried out in a "
        "shrill but distinct voice, _Hekinah degul_: the others repeated "
    ...
    (
        ...
        "mortifying in this case by my spite: I know better than anyone "
        "that by all this I am only injuring myself and no one else.",
        ["spiteful"],
    ),
    (
        ...
        "with garret, dinners, and attendance, lived on the floor below, "
        "and every time he went out he was obliged to pass her kitchen, "
        "the door of which invariably stood open. And each time he "
    ...
    (
        ...
        "its own way. Everything was in confusion in the Oblonskys' "
        "house. The wife had discovered that the husband was carrying on "
        ...
        "position of affairs had now lasted three days, and not only the "
        "husband and wife themselves, but all the members of their "
        "family and household, were painfully conscious of it. Every "
        "person in the house felt that there was no sense in their "
        "living together, and that the stray people brought together by "
        "chance in any inn had more in common with one another than "
        "they, the members of the family and household of the Oblonskys.",
        ["intrigue"],
    ),
    (
        ...
        "mysterious and puzzling phenomenon, which doubtless no one has "
        "yet forgotten. Not to mention rumours which agitated the "
        "maritime population and excited the public mind, even in the "
        "interior of continents, seafaring men were particularly "
        ...
        "continents, were deeply interested in the matter. For some time "
        "past, vessels had been met by “an enormous thing,” a "
        "long object, spindle-shaped, occasionally phosphorescent, and "
        "infinitely larger and more rapid in its movements than a whale.",
        ["signalised", "phosphorescent"],
    ),
    (
        "src-verne-phileas-fogg-lived",
        "Around the World in Eighty Days", "Jules Verne", 1873, 103,
        "Phileas Fogg lived, in 1872, at No. 7, Saville Row, Burlington "
        "Gardens, the house in which Sheridan died in 1814. He was one of "
        "the most noticeable members of the Reform Club, though he "
        "seemed always to avoid attracting attention; an enigmatical "
        "personage, about whom little was known, except that he was a "
        "polished man of the world. People said that he resembled "
        "Byron—at least that his head was Byronic; but he was a "
        "bearded, tranquil Byron, who might live on a thousand years "
        "without growing old. Certainly an Englishman, it was more "
        "doubtful whether Phileas Fogg was a Londoner. He was never seen "
        "on 'Change, nor at the Bank, nor in the counting-rooms of the "
        "'City'; no ships ever came into London docks of which he was the "
        "owner; he had no public employment.",
        ["enigmatical"],
    ),
]
