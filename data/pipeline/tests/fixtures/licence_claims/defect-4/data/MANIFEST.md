...
| Wiktionary | Wiktionary contributors | CC BY-SA 4.0 | https://example.org | 2026-01-01 | `data/pipeline/glosses.py` — gloss text, attribution to Wiktionary is required wherever a gloss surfaces |

## Content licence

The passage library and the slot classes are released **CC0**. Rewritten
glosses carry Wiktionary's credit and share-alike terms, not CC0.
